...
public class CreateSMSCommandHandler : IRequestHandler<CreateSMSCommand, Guid>
{
    ...
    public async Task<Guid> Handle(CreateSMSCommand request, CancellationToken cancellationToken)
    {
        SMS sms = new SMS
        {
            Id = Guid.NewGuid(),
